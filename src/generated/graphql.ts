...
export type CancelTorrentMutation = {
  __typename?: "Mutation";
  filestoreMutations: {
    __typename?: "FilestoreMutations";
    cancelTorrent?: {
...
export type ExpireTailscaleDeviceMutation = {
  __typename?: "Mutation";
  gaiaMutations: {
    __typename?: "GaiaMutations";
    expireTailscaleDevice?:
      | { __typename: "FormError" }
...
export type CreateIpWhitelistEntryMutation = {
  __typename?: "Mutation";
  gaiaMutations: {
    __typename?: "GaiaMutations";
...
export type DeleteIpWhitelistEntryMutation = {
  __typename?: "Mutation";
  gaiaMutations: {
    __typename?: "GaiaMutations";
...
export type IpWhitelistEntriesQuery = {
  __typename?: "Query";
  gaiaQueries: {
    __typename?: "GaiaQueries";
...
export type UpdateIpWhitelistEntryMutation = {
  __typename?: "Mutation";
  gaiaMutations: {
    __typename?: "GaiaMutations";
...
export type GetPresignedDownloadUrlMutation = {
  __typename?: "Mutation";
  filestoreMutations: {
    __typename?: "FilestoreMutations";
...
export type HealthQuery = {
  __typename?: "Query";
  filestoreQueries: { __typename?: "FilestoreQueries"; health?: string | null };
};
...
export type ListBucketsQuery = {
  ...
  filestoreQueries: {
    ...
    listBuckets?: Array<{
      ...
      id: string;
      created?: string | null;
      globalAliases?: Array<string> | null;
      localAliases?: Array<string> | null;
    }> | null;
  };
};
...
export type LocateKeyDetailQuery = {
  __typename?: "Query";
  filestoreQueries: {
    __typename?: "FilestoreQueries";
    locate?: {
...
export type SearchTorrentsQuery = {
  __typename?: "Query";
  filestoreQueries: {
    __typename?: "FilestoreQueries";
    searchTorrents: Array<{
      __typename?: "TorrentSearchResult";
      name: string;
      seeders: number;
      leechers: number;
...
export type TailscaleDeviceQuery = {
  __typename?: "Query";
  gaiaQueries: {
    __typename?: "GaiaQueries";
    tailscaleDevice?: {
...
export type TailscaleDevicesQuery = {
  __typename?: "Query";
  gaiaQueries: {
    __typename?: "GaiaQueries";
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "targetKeyPath" },
                      },
                      {
                        kind: "Field",
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "magnetDetail" },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                            {
...
export const CancelTorrentDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
...
export const ExpireTailscaleDeviceDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "expireTailscaleDevice" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
  ...
  ExpireTailscaleDeviceMutation,
  ExpireTailscaleDeviceMutationVariables
>;
...
export const CreateIpWhitelistEntryDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "createIpWhitelistEntry" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "IpWhitelistEntryInput" },
            },
          },
        },
      ],
...
>;
export const DeleteIpWhitelistEntryDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "deleteIpWhitelistEntry" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
...
export const IpWhitelistEntriesDocument = {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "ipWhitelistEntries" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
  ...
  IpWhitelistEntriesQuery,
  IpWhitelistEntriesQueryVariables
>;
...
>;
export const UpdateIpWhitelistEntryDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "updateIpWhitelistEntry" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
...
>;
export const GetPresignedDownloadUrlDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "getPresignedDownloadUrl" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "filestoreQueries" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
...
export const ListBucketsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "listBuckets" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "globalAliases" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "localAliases" },
                      },
                    ],
                  },
                },
...
} as unknown as DocumentNode<ListBucketsQuery, ListBucketsQueryVariables>;
                      ...
                      },
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "magnetDetailId" },
                            },
                            {
                              kind: "Field",
                            ...
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "etaSeconds" },
                            },
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "peersConnected" },
                            },
                            {
                              kind: "Field",
...
} as unknown as DocumentNode<ListKeysQuery, ListKeysQueryVariables>;
export const LocateKeyDetailDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "locateKeyDetail" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
...
>;
export const PutKeyDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "putKey" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "PutKeyInput" },
            },
          },
        },
      ],
...
} as unknown as DocumentNode<PutKeyMutation, PutKeyMutationVariables>;
export const RenameKeyDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "RenameKeyInput" },
            },
          },
        },
      ],
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "hasConflicts" },
                      },
                      {
                        kind: "Field",
...
} as unknown as DocumentNode<RenameKeyMutation, RenameKeyMutationVariables>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "searchTorrents" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
...
} as unknown as DocumentNode<SearchTorrentsQuery, SearchTorrentsQueryVariables>;
export const TailscaleDeviceDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "tailscaleDevice" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "headscaleId" },
                      },
                      { kind: "Field", name: { kind: "Name", value: "name" } },
  ...
  TailscaleDeviceQuery,
  TailscaleDeviceQueryVariables
>;
export const TailscaleDevicesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "tailscaleDevices" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
  ...
  TailscaleDevicesQueryVariables
>;
