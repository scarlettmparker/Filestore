...
export function graphql(
  source: "mutation addTorrent($input: AddTorrentInput!) {\n  filestoreMutations {\n    addTorrent(input: $input) {\n      id\n      bucket\n      targetKeyPath\n      status\n      progress\n      magnetDetail {\n        displayName\n      }\n    }\n  }\n}",
): (typeof documents)["mutation addTorrent($input: AddTorrentInput!) {\n  filestoreMutations {\n    addTorrent(input: $input) {\n      id\n      bucket\n      targetKeyPath\n      status\n      progress\n      magnetDetail {\n        displayName\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation cancelTorrent($jobId: String!) {\n  filestoreMutations {\n    cancelTorrent(jobId: $jobId) {\n      id\n      status\n    }\n  }\n}",
 ...
 */
export function graphql(
  source: "mutation deleteKey($input: BucketKeyInput!) {\n  filestoreMutations {\n    deleteKey(input: $input)\n  }\n}",
): (typeof documents)["mutation deleteKey($input: BucketKeyInput!) {\n  filestoreMutations {\n    deleteKey(input: $input)\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation expireTailscaleDevice($id: ID!) {\n  gaiaMutations {\n    expireTailscaleDevice(id: $id) {\n      __typename\n      ... on QuerySuccess {\n        message\n        id\n      }\n      ... on StandardError {\n        message\n      }\n    }\n  }\n}",
 ...
 */
export function graphql(
  source: "mutation createIpWhitelistEntry($input: IpWhitelistEntryInput!) {\n  gaiaMutations {\n    createIpWhitelistEntry(input: $input) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation createIpWhitelistEntry($input: IpWhitelistEntryInput!) {\n  gaiaMutations {\n    createIpWhitelistEntry(input: $input) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation deleteIpWhitelistEntry($id: ID!) {\n  gaiaMutations {\n    deleteIpWhitelistEntry(id: $id) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation deleteIpWhitelistEntry($id: ID!) {\n  gaiaMutations {\n    deleteIpWhitelistEntry(id: $id) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query ipWhitelistEntries {\n  gaiaQueries {\n    ipWhitelistEntries {\n      id\n      pattern\n      description\n      enabled\n      immutable\n      createdAt\n      updatedAt\n    }\n  }\n}",
 ...
 */
export function graphql(
  source: "mutation updateIpWhitelistEntry($id: ID!, $input: IpWhitelistEntryInput!) {\n  gaiaMutations {\n    updateIpWhitelistEntry(id: $id, input: $input) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}",
): (typeof documents)["mutation updateIpWhitelistEntry($id: ID!, $input: IpWhitelistEntryInput!) {\n  gaiaMutations {\n    updateIpWhitelistEntry(id: $id, input: $input) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "mutation getPresignedDownloadUrl($input: BucketKeyInput!) {\n  filestoreMutations {\n    getPresignedDownloadUrl(input: $input)\n  }\n}",
