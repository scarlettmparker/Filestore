...
type Documents = {
    ...
    "mutation createIpWhitelistEntry($pattern: String!, $description: String) {\n  gaiaMutations {\n    createIpWhitelistEntry(pattern: $pattern, description: $description) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}": typeof types.CreateIpWhitelistEntryDocument,
    ...
    "mutation updateIpWhitelistEntry($id: ID!, $pattern: String!, $description: String, $enabled: Boolean) {\n  gaiaMutations {\n    updateIpWhitelistEntry(\n      id: $id\n      pattern: $pattern\n      description: $description\n      enabled: $enabled\n    ) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}": typeof types.UpdateIpWhitelistEntryDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation createIpWhitelistEntry($pattern: String!, $description: String) {\n  gaiaMutations {\n    createIpWhitelistEntry(pattern: $pattern, description: $description) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"): (typeof documents)["mutation createIpWhitelistEntry($pattern: String!, $description: String) {\n  gaiaMutations {\n    createIpWhitelistEntry(pattern: $pattern, description: $description) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation updateIpWhitelistEntry($id: ID!, $pattern: String!, $description: String, $enabled: Boolean) {\n  gaiaMutations {\n    updateIpWhitelistEntry(\n      id: $id\n      pattern: $pattern\n      description: $description\n      enabled: $enabled\n    ) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"): (typeof documents)["mutation updateIpWhitelistEntry($id: ID!, $pattern: String!, $description: String, $enabled: Boolean) {\n  gaiaMutations {\n    updateIpWhitelistEntry(\n      id: $id\n      pattern: $pattern\n      description: $description\n      enabled: $enabled\n    ) {\n      ... on QuerySuccess {\n        __typename\n        message\n        id\n      }\n      ... on StandardError {\n        __typename\n        message\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
